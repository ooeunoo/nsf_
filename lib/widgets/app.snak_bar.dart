...
//     //     bottom: height ?? 0, left: AppDimens.size20, right: AppDimens.size20),
//     content: content,
//   );
// }

// void notifyRegisterWod() {
//   Get.context!.showSnackBar(appSnackBar(
//       Get.context!,
...
//         child: Row(
//           children: [
//             AppText('오늘의 운동을 등록했어요',
//                 style: Theme.of(Get.context!).textTheme.textSM.copyWith(
//                     color: AppColor.gray50, fontWeight: AppFontWeight.regular)),
//           ],
//         ),
//       )));
